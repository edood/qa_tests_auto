...
public class HighlightElement {
	...
	private static List<String> influencedKeywords = ['click', 'selectOptionByIndex', 'selectOptionByLabel', 'selectOptionByValue', 'setEncryptedText', 'setText', 'verifyElementText', 'verifyElementChecked', 'verifyOptionSelectedByValue', 'verifyElementAttributeValue', 'focus']
