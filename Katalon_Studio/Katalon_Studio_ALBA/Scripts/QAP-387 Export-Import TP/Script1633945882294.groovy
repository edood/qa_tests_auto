...
CustomKeywords.'com.reusableComponents.CheckingProfile.checkProfile'('QAP-387')
...
sheetTitle = CustomKeywords.'project.Albatros.exportIndicators'(name[0], name[1])
CustomKeywords.'project.Albatros.openSpreadsheet'(sheetTitle, false)
createindic = CustomKeywords.'project.Albatros.createindicatorfromgsheet'(GlobalVariable.GsheetIndicators)

WebUI.switchToWindowIndex(0)
CustomKeywords.'project.Albatros.importIndicators'(sheetTitle, false, true)
