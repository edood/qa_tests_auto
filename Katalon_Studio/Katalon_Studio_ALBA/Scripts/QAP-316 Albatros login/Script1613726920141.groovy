...
CustomKeywords.'project.Albatros.logout'()
CustomKeywords.'project.Albatros.login'(GlobalVariable.googleID, GlobalVariable.googlePassword, GlobalVariable.checkHref, true)
assert WebUI.waitForElementPresent(findTestObject('5. Homepage/Welcome header'), 10) : "Login failed"