...
WebUI.click(findTestObject('DV360 Optimizer/3.Grid/1. Filter column/Third column filter button'))

WebUI.selectOptionByLabel(findTestObject('DV360 Optimizer/3.Grid/1. Filter column/Filter select'), "Greater than", false)

WebUI.setText(findTestObject('DV360 Optimizer/3.Grid/1. Filter column/Filter value'), "100")
