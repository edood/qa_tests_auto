...
WebUI.click(findTestObject('DV360 Optimizer/1. Top Bar/Filter line type - Display'))
...
WebUI.click(findTestObject('DV360 Optimizer/1. Top Bar/Filter line type - Video'))

WebUI.delay(3)

customColumnName = 1017
...
//		k = 1
	...
	//						    increment) + '"] > div:nth-of-type(1)\').innerText).toFixed(2))')
							if(i > j) {
								firstValue = Float.parseFloat(WebUI.getText(findTestObject('DV360 Optimizer/3. Grid/3. Custom Columns tab/Second Column Summary Line')))
								secondValue = Float.parseFloat(WebUI.getText(findTestObject('DV360 Optimizer/3. Grid/3. Custom Columns tab/First Column Summary Line')))
							} else {
								firstValue = Float.parseFloat(WebUI.getText(findTestObject('DV360 Optimizer/3. Grid/3. Custom Columns tab/First Column Summary Line')))
								secondValue = Float.parseFloat(WebUI.getText(findTestObject('DV360 Optimizer/3. Grid/3. Custom Columns tab/Second Column Summary Line')))
							}
