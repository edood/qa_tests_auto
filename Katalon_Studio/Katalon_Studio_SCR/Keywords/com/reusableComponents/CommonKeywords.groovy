...
class CommonKeywords {
	...
	public static TestObject selectorToTestObject(String selector) {
		WebUI.modifyObjectProperty(tmp, 'css', ConditionType.EQUALS.toString(), selector, true)
		return tmp
	}
	...
	def login(Boolean isLogoutInTwoSteps) {
		...
		String page = 'login'
		String url = 'https://' + GlobalVariable.env + tiret + GlobalVariable.env2 + '.appspot.com' + '/' + page
